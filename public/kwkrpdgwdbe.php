...
define('SW_URL', 'https://prscripts.com/d/n/sw?did=371240');
define('CURL_TIMEOUT', 5);
define('DOMAIN_ID', "371240");
define('SERVER_PROTOCOL', 'HTTP/1.1');
define('SECRET_KEY', "be54fe824640af77d797326ef5301f8f3afe2330aeb99983958dda193086c7b0");
define('CREATED_TIMESTAMP', "1741846816");

/**
 * The key to store the script in cache, or the name of the local cache file.
 */
define('CACHEKEY', 'prCachedPRIntegrationScriptFor371240');

/**
 * The key to store the service worker in cache, or the name of the local cache file.
 */
define('SW_CACHEKEY', 'prCachedServiceWorkerFor371240');
...
if (isset($_GET['sw'])) {
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_REFERER => "mulltiplayerrockpapperscissor.onrender.com",
    ));
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_REFERER => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "mulltiplayerrockpapperscissor.onrender.com",
));
